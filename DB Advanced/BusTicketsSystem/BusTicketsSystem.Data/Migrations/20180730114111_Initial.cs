    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusCompanyReviews", x => new { x.BusCompanyId, x.ReviewId });
                    table.ForeignKey(
                        name: "FK_BusCompanyReviews_BusCompanies_BusCompanyId",
                        column: x => x.BusCompanyId,
                        principalTable: "BusCompanies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BusCompanyReviews_Reviews_ReviewId",
                        column: x => x.ReviewId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusCompanyReviews_ReviewId",
                table: "BusCompanyReviews",
                column: "ReviewId");
